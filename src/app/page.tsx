    ...
    <main className="grid min-h-screen grid-cols-2">
      ...
      <div className="relative flex flex-col items-start justify-between overflow-hidden border-r border-white/10 bg-[url(../assets/bg-starts.svg)] bg-cover px-28 py-16">
        ...
        <div className="space-y-5">
          {' '}
          {/* Adiciona um espaço entre cada elemento de (5*4) 20px */}
        ...
        <div className='text-sm leading-relaxed text-gray-200'>
          Feito com 💜 no NLW da{' '}
          <a target='_blank' className="underline hover:text-gray-100" href="https://www.rocketseat.com.br/">Rocketseat</a>
        </div>
      </div>
